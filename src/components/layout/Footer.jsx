  ...
  return (
    <footer className="bg-gray-900 text-white py-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-secondary-orange/10 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 h-60 bg-muted-pink/10 rounded-full blur-3xl"></div>
      </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 max-w-3xl mx-auto">
              ...
              >
                ...
                <div className="relative flex flex-col items-center gap-2">
                  ...
                  <span className="text-sm text-gray-400 group-hover:text-primary transition-colors">Facebook</span>
                </div>
              </motion.a>
              ...
              >
                ...
                <div className="relative flex flex-col items-center gap-2">
                  ...
                  <span className="text-sm text-gray-400 group-hover:text-primary transition-colors">Twitter</span>
                </div>
              </motion.a>
              ...
              >
                ...
                <div className="relative flex flex-col items-center gap-2">
                  ...
                  <span className="text-sm text-gray-400 group-hover:text-primary transition-colors">Instagram</span>
                </div>
              </motion.a>
